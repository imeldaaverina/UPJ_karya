...
-- Dumping database structure for uts_sbd
DROP DATABASE IF EXISTS `uts_sbd`;
CREATE DATABASE IF NOT EXISTS `uts_sbd` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `uts_sbd`;

-- CREATE DATABASE `UPJ_karya`;
-- USE `UPJ_karya`;


-- Dumping structure for table uts_sbd.phonebook
...
-- Dumping data for table uts_sbd.phonebook: 10 rows
