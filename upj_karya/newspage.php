        ...
        <div class="all">
            ...
            <div class="content">
                    ...
                    <div class="profil">
                        ...
                        <div class="penulis-2">
                            <div class="nama-penulis">
                               Ditulis oleh: <?php echo $posts['nama_author']; ?>
                            </div>
                            <div class="jabatan"><?php echo $posts['tanggal_upload']; ?></div>
                        </div>
                    </div>
                    <div class="laporkan">
                ...
                <div class="berita-section">
                    <div class="berita"  style="width:900px;">
                        <div class="isi-berita" id="isi-berita" style="width:1051px;box-shadow:none;">
                          <?php echo $posts['isi_artikel']; ?>
                        </div>
                    </div>
