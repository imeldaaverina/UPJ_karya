...
<!--             
                ...
                <!-- <% } else { %> -->
                    <form class="access">
                        <input type="button" class="login-button" style="height:27px;width:75px;margin-top:25px;border-radius:5px;margin-right:5px;" onClick="document.location.href='/projeksbd/upj_karya/pilih_login.html'" value="Log In"/>
                        <input type="button" class="register-button" style="height:27px;width:75px;margin-top:25px;border-radius:5px;" onClick="document.location.href='/projeksbd/upj_karya/pilih_register.html'" value="Register"/>
                    </form>
                    <!-- <script type=""></script> -->
                    </div>
                <!-- <% } %> -->